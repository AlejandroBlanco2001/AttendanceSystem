...
const Classroom = () => {
  ...
  const addClassroom = () => {
    axios
      ...
      .catch((er) => {
        alert(
          "You`re trying to add a classroom whose primary key is already in existance."
        );
        console.log(er);
      });
  };
  ...
  const deleteClassroom = (id) => {
    axios
      .post(
        `http://localhost:80/admin/delete/classrooms/${id}`,
        { 1: true },
  ...
  const updateClassroom = () => {
    axios
      .post(
        `http://localhost:80/admin/update/classrooms/${updatedUser.code}`,
        {
  ...
  return (
    <main className="main-users">
      ...
      <div className="table">
        <Table
          tableheads={["Classroom's Code", "Classroom Type", "Actions"]}
